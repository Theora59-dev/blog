+++
title = "Génération d'image BMP simple"
date = 2026-01-16
categories = ["C"]
description = "Génération d'image simple représentant Saturne dans le cadre d'un projet étudiant"
...
Pour la programation, j'ai choisis de me baser sur une logique de fonctions booléennes, ce que m'a rendu le travail plus simple pour la suite du projet. 
...
---
Nous obtenons alors l'image ci-dessus, qui m'a permis d'avoir un modeste XX/20 à l'UE (matière) Systèmes Logique et Numériques !
