# Ascendustry - Comment le réseau fonctionne en interne

> Posté le 6 mai 2026

J'ai récemment travaillé sur **Ascendustry**, une ébauche de jeu voxel multijoueur en Rust développé from scratch avec [@StrachyDev](https://github.com/strachydev). Le projet ayant atteint un stade très correct de maturité, j'ai souhaité vous faire part de l'architecture et du système réseau que j'ai implémenté pour relier le client et le serveur. (Ça me permettra aussi d'avoir une trace du système et son évolution pour la suite du projet)

![Architecture globale](../assets/images/ascendustry/architecture.svg)
...
![Flux de connexion serveur](../assets/images/ascendustry/flux-connexion.svg)

---

## Format d'un paquet sur le réseau

![Format d'un paquet](../assets/images/ascendustry/format-paquet.svg)
...
![Diagramme de séquence du handshake](../assets/images/ascendustry/handshake.svg)
...
![Architecture async client](../assets/images/ascendustry/async-client.svg)
...
![Broadcast des positions](../assets/images/ascendustry/broadcast.svg)
...
![Dérivation de la clé secrète](../assets/images/ascendustry/derivation-cle.svg)
...
![Chiffrement AES-256-GCM](../assets/images/ascendustry/chiffrement.svg)
...
![Récapitulatif global](../assets/images/ascendustry/recap.svg)

Ascendustry a une base réseau propre : Tokio pour l'async, des channels mpsc pour séparer reading/writing, et AES-256-GCM pour chiffrer les échanges.
